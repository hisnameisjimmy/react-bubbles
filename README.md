...
A token is used to authenticate requests to a server from a trusted entity

- [ ] What steps can you take in your web apps to keep your data secure?

Use https, and make sure that all requests are authenticated

- [ ] Describe how web servers work.

A server listens for incoming requests from trusted protocols to APIs that take in structured requests and return structured data. 
